...
describe('NotificationService', () => {
  ...
  describe('createNotificationPatient', () => {
    it('should create a notification for a cancelled appointment and send an email', async () => {
      ...
      const expectedNotification = {
        title: 'Appointment (60d7e3e0a3b4e4a2c8a7e3d1) cancelled',
        ...
        to: 'dentistplatform2@gmail.com'
      };

      // Call the NotificationService function
      const result = await NotificationService.createNotificationPatient(inputData);
